	...
	public static void main(String[] args) {
		...
		try {
			...
			if (client.waitForConnection(30000)) {
				...
				// URL: https://developer.thingworx.com/resources/guides/thingworx-java-sdk-quickstart/calling-services-and-queueing-events
				...
				client.invokeService(ThingworxEntityTypes.Things, "SystemRepository", "CreateTextFile", params, 5000);
				...
				// we just created.
				result = client.invokeService(ThingworxEntityTypes.Things, "SystemRepository", "GetFileInfo", params, 5000);
				...
				LOG.info("                  date: {}", row.getPrimitive("lastModifiedDate").getStringValue());
